...
$I->wantTo( 'create and check carousel header(zoom-and-slide-to-gray) block' );
...
$I->see( 'Header 1', '.carousel-caption > .main-header > h1' );
$I->see( 'Subheader 1', '.carousel-caption > .main-header > h2' );
$I->see( 'Image 1 description', '.carousel-caption > .main-header > p' );
$I->see( 'Act', 'a.btn-primary' );
// Check open in new tab setting.
$I->canSeeElement( 'a.btn-primary', [ 'target' => '_blank' ] );
$I->scrollTo( '.zoom-and-slide-to-gray' );
...
$I->see( 'Header 2', '.carousel-caption > .main-header > h2' );
$I->see( 'Subheader 2', '.carousel-caption > .main-header > h2' );
